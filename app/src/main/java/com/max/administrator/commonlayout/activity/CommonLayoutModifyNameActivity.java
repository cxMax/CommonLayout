...
import com.max.administrator.commonlayout.common.baseadapter.utils.factory.bean.ModifyNameType;
 ...
 * @author max
 */
public class CommonLayoutModifyNameActivity extends TrainOnlineBaseActivity {
    ...
    public void initType() {
        ...
        ModifyNameType type = factory.createType(ModifyNameType.class);
        items = type.selfType();
    }
    ...
    public void initActionBar() {
        ...
        getActionbar().getActionCenterBtn().setText("修改昵称");
