...
/**
 * 短信登录 继承ItemClickListener接口,实现各控件相关业务
 * 
 * @author max
 * 
 */
public class CommonLayoutSmsLoginActivity extends TrainOnlineBaseActivity {
    private List<LoginItem> items;
    private Button signTV;// ,登录

    @Override
    public void initView() {
        super.initView();
        signTV = (Button) findViewById(R.id.login_signTV);
        signTV.setBackgroundColor(Color.parseColor("#E7E5EA"));
    }
    ...
    public void initActionBar() {
        ...
        getActionbar().getActionCenterBtn().setText("短信验证登录");
    ...
    public void onActionBarClick(View view) {
        switch (view.getId()) {
            case R.id.top_right:
                // 跳转到注册页面
                startActivity(new Intent(CommonLayoutSmsLoginActivity.this,
