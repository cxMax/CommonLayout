package com.max.administrator.commonlayout.utils.uitools;
...
import com.max.administrator.commonlayout.utils.DisplayUtils;
...
public class CommonToast {
	...
	public static final long DURATION_TWEEN = 2000L;
	...
	public void setLayoutGravity(int i) {
		if (i != 0) {
			FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(-2,
					-2);
			params.gravity = i;
			int j = (int) DisplayUtils.dip2px(_toastVw.getContext(), 16F);
	...
	public void show() {
		...
		if (content != null) {
			...
			Log.e("info", "Toast not shown! Content view is null!");
		}
	}
		...
		private class ToastView extends FrameLayout {
			...
			private void init() {
				LayoutInflater.from(getContext()).inflate(R.layout.view_toast,
						this, true);
